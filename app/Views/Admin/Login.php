          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                ...
                <img src="/assets/admin/images/LogoPemProvJPG.jpg" alt="logo">
              </div>
              ...
              <form class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="/assets/admin/index.html">SIGN IN</a>
                </div>
